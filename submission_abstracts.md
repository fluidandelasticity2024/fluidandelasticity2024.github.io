...
A one-page abstract must be uploaded on the conference management system **no later than February 15, 2024** (the abstract repository will be opened on August 1 2023). The abstract LaTeX template can be downloaded **<a href="/assets/template/Abstract_template_F&E2024.zip" download> here </a>**.
