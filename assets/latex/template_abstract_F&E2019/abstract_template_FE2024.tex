...
\fancyhead[RO]{\textsf{F\&E 2024}} 
\fancyhead[RE]{\rightmark}
\fancyhead[LE]{\textsf{F\&E 2024}}
...
%
\large
\underline{C. Eloy$^{\sst 1}$}, E. Lauga$^{\sst 2}$, S. Michelin$^{\sst 3}$, Fran\c cois Nadal $^{4}$ and T. Bickel$^{5}$\\[5mm]%auteurs
%
\end{center}
\small
%
